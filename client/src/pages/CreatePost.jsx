...
export default function CreatePost() {
  ...
  const handleSubmit = async()=> {
   ...
   const post_type = images.length && content ? "text_with_image" : image.length ? 'image': 'text'
   try {
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md
            space-y-4'>
              ...
              <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400' 
                placeholder="What's happening?" value={content} onChange={(e) => setContent(e.target.value)}/>
