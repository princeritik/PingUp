...
export default function StoryViewer({viewStory,setViewStory}) {
  ...
  const renderContent = ()=>{
    switch(viewStory.media_type){
      ...
      case "video":
        return (
          <video onEnded={()=> setViewStory(null)} src={viewStory.media_url} className='max-h-screen object-contain' 
            controls autoPlay/>
        );
  ...
  return (
    ...
    justify-center' style={{backgroundColor: viewStory.media_type === 'text' ? viewStory.background_color : "#000000"}}   >
